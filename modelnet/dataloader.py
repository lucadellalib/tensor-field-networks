# -*- coding: utf-8 -*-
"""
    ModelNet dataloader. ModelNet40, ModelNet10, XYZ and normal channels supported. Up to 10000 points.
"""
...
if __name__ == "__main__":
    d = ModelNetDataloader(root = "../data/modelnet40_normal_resampled", split="test")
    print(d.shuffle)
    print(len(d))
    import time
    tic = time.time()
